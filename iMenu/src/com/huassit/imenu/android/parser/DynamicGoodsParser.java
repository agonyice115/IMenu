...
public class DynamicGoodsParser extends BaseParser<Map<String, Object>> {
        ...
        if (!jsonObject.isNull("data")) {
            ...
            for (int i = 0; i < jsonData.length(); i++) {
                ...
                for (int j = 0; j < jsonGoodsList.length(); j++) {
                    ...
                    goods.dynamic_goods_id = goodsObject.optString("dynamic_goods_id");
                ...
                memberGoods.dynamic_goods_id = jsonMemberGoods.optString("dynamic_goods_id");
