...
/**
 * <p>Title: PullToRefreshView.java</p>
 * <p>Description: TODO(刷新，加载数据)</p>
 * <p>Copyright: Copyright (c) 2013</p>
 * <p>Company: Xi'an Huatek</p>
 * <p>CreateTime: Oct 28, 2013 6:14:17 PM</p>
 *
 * @author Andy.Chen
 * @version %A%, %B%
 * @CheckItem
...
//	private String mLastUpdateTime;
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.view_refreshheader, this, false);
        ...
        mHeaderUpdateTextView.setText(getResources().getString(R.string.pulltorefreshview_update) + sdf.format(date));
        //System.out.println("更新于:" + sdf.format(date));
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.view_refreshfooter, this, false);
...
//				Log.i(TAG, "pull up!parent view move!");
    ...
    private boolean isRefreshViewScroll(int deltaY) {
        ...
        if (mScrollView != null) {
            ...
            if (deltaY > 8 && mScrollView.getScrollY() == 0) {
                mPullState = PULL_DOWN_STATE;
                return true;
            } else if (deltaY < -10
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.drawable.global_pulltorefresh_arrow);
        mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(R.drawable.global_pulltorefresh_arrow_up);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
