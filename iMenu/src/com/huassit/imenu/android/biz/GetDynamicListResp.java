...
public class GetDynamicListResp extends BaseInvoker {
	...
	public GetDynamicListResp(Activity ctx, Handler handler, String token,
			String memberId, String viewMemberId, String dynamicCount,
			String page, String menuCount, String filterDateType,
			String longitude, String latitude, String dynamicLastDate,
			String dynamicType) {
		super(ctx, handler);
		...
		dynamicParser = new DynamicParser(0);// 公用解析类，传0，不区分时间分类
	}
