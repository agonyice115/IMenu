 ...
 * 
 */
public class GetReturnDetailResp extends BaseInvoker {

	private RefundOrderDetailParser mDetailParser;
	...
	public GetReturnDetailResp(Activity ctx, Handler handler, String token,
			String memberId, String order_id) {
		super(ctx, handler);
		this.memberId = memberId;
		this.order_id = order_id;
		this.token = token;
		mDetailParser = new RefundOrderDetailParser();
	}

	@Override
	public List<NameValuePair> getParameters() {
		List<NameValuePair> nvp = new ArrayList<NameValuePair>();
		nvp.add(new BasicNameValuePair("route", API.GET_RETURN_DETAIL));
