 ...
 */
public class ShareMemberDao extends BaseDao<Share> {
    public ShareMemberDao(Context context) {
        super(context);
    }
    ...
    public void save(Share share) {
        ...
        database.insert(DbConstants.TABLE.TABLE_SHARE_MEMBER, null, values);
    }
    ...
    public void update(Share share) {
        ...
        values.put(DbConstants.COLUMN_SHARE.CONTENT, share.content);
        values.put(DbConstants.COLUMN_SHARE.LINK, share.link);
        database.update(DbConstants.TABLE.TABLE_SHARE_MEMBER, values, DbConstants.COLUMN_SHARE.TITLE + "=?", new String[]{share.title});
    }
    ...
    public boolean isExits(Share share) {
        ...
        Cursor cursor = null;
        try {
            final String sql = "select count(*) from " + DbConstants.TABLE.TABLE_SHARE_MEMBER + " where " + DbConstants.COLUMN_SHARE.TITLE + " =?";
    ...
    public Share getShareMember() {
        String sql = "select * from " + DbConstants.TABLE.TABLE_SHARE_MEMBER;
        Cursor cursor = null;
        Share share = null;
        try {
