 ...
 */
public class ShareStoreDao extends BaseDao<Share> {
    public ShareStoreDao(Context context) {
        super(context);
    }
    ...
    public void save(Share share) {
        ...
        database.insert(DbConstants.TABLE.TABLE_SHARE_STORE, null, values);
    }
    ...
    public void update(Share share) {
        ...
        values.put(DbConstants.COLUMN_SHARE.CONTENT, share.content);
        values.put(DbConstants.COLUMN_SHARE.LINK, share.link);
        database.update(DbConstants.TABLE.TABLE_SHARE_STORE, values, DbConstants.COLUMN_SHARE.TITLE + "=?", new String[]{share.title});
    }
    ...
    public boolean isExits(Share share) {
        ...
        Cursor cursor = null;
        try {
            final String sql = "select count(*) from " + DbConstants.TABLE.TABLE_SHARE_STORE + " where " + DbConstants.COLUMN_SHARE.TITLE + " =?";
    ...
    public Share getShareStore() {
        String sql = "select * from " + DbConstants.TABLE.TABLE_SHARE_STORE;
        Cursor cursor = null;
        Share share = null;
        try {
