 ...
 */
public class ShareDynamicDao extends BaseDao<Share> {
    public ShareDynamicDao(Context context) {
        super(context);
    }
    ...
    public void save(Share share) {
        ...
        database.insert(DbConstants.TABLE.TABLE_SHARE_DYNAMIC, null, values);
    }
    ...
    public void update(Share share) {
        ...
        values.put(DbConstants.COLUMN_SHARE.CONTENT, share.content);
        values.put(DbConstants.COLUMN_SHARE.LINK, share.link);
        database.update(DbConstants.TABLE.TABLE_SHARE_DYNAMIC, values, DbConstants.COLUMN_SHARE.TITLE + "=?", new String[]{share.title});
    }
    ...
    public boolean isExits(Share share) {
        ...
        Cursor cursor = null;
        try {
            final String sql = "select count(*) from " + DbConstants.TABLE.TABLE_SHARE_DYNAMIC + " where " + DbConstants.COLUMN_SHARE.TITLE + " =?";
    ...
    public Share getShareDynamic() {
        String sql = "select * from " + DbConstants.TABLE.TABLE_SHARE_DYNAMIC;
        Cursor cursor = null;
        Share share = null;
        try {
